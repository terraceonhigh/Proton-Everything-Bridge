...
╚══════════════════════════════════════════════════════════════╝${NC}
  ...
  After setup, use ./manage.sh to add your Proton accounts.
...
cd "$SCRIPT_DIR"
# Escape $ signs in AUTH_HASH so docker-compose treats them literally.
# Docker Compose .env files use $$ to represent a literal $.
